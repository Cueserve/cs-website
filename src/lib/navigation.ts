...
export const MEGA_MENU_MAP: Record<MenuKey, MegaMenuConfig> = {
  ...
  services: {
    ...
    subMenuLinks: [
      { label: "Custom Software & Product Development", href: "/services#custom-software" },
      { label: "Mobile & Web Application Development", href: "/services#mobile-web" },
      { label: "Legacy System Modernization & Migration", href: "/services#legacy-modernization" },
      { label: "AI-Powered Workflow & Process Automation", href: "/services#ai-automation" },
      { label: "AI Agent Development & Deployment", href: "/services#ai-agents" },
      { label: "Data Engineering & Analytics Solutions", href: "/services#data-engineering" },
      { label: "Cloud Infrastructure & DevSecOps", href: "/services#cloud-devops" },
    ],
