      ...
      >
        ...
        <div className="mx-auto w-[96%] sm:w-[90%] xl:w-[82%] max-w-[1260px] flex justify-center xl:justify-end">
          ...
          <div className="w-full max-w-[480px] sm:max-w-[540px] xl:max-w-[720px] 2xl:max-w-[780px] 3xl:max-w-[840px] text-center xl:text-right mt-6 sm:mt-8 md:mt-10 xl:mt-12 shrink-0">
            ...
            <h1
              data-hero-title
              className="text-hero-title text-text-primary mb-3 sm:mb-4 xl:mb-6"
            >
              <span className="whitespace-nowrap">Crafting Modern</span>{" "}
              <br className="hidden xl:inline" />
              <span className="inline xl:inline-flex items-center justify-center xl:justify-end gap-2 sm:gap-3 md:gap-4 text-brand-default my-1 sm:my-1.5 whitespace-normal xl:whitespace-nowrap">
            ...
            <p
              data-hero-desc
              className="text-para text-text-secondary mb-5 sm:mb-6 xl:mb-8 mx-auto xl:mx-0 xl:ml-auto max-w-[340px] sm:max-w-[420px] xl:max-w-[440px] 2xl:max-w-[470px] text-center xl:text-right"
            >
