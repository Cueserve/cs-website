    ...
    return (
      ...
      >
        ...
        <div className="w-[95%] xl:w-[88%] max-w-[1380px] mx-auto h-full flex flex-col justify-start relative">
          ...
          <div className="w-full pt-20 sm:pt-24 md:pt-28 xl:pt-36 pb-4 sm:pb-6 md:pb-8 xl:pb-10 flex items-center justify-center relative border-t border-white/85 border-b border-[#a6c8e0]/75">
          ...
          <div className="w-full h-[1px] bg-[#cbd5e1] shrink-0 relative z-30" />
