...
export function Footer() {
  return (
    <footer 
      className="relative w-full border-t border-[#D1E0FF] pt-40 flex flex-col items-center"
    ...
    >
      <div className="w-[90%] xl:w-[82%] max-w-[1260px] mx-auto flex flex-col @container">
        {/* Title Group */}
        <div className="flex items-center w-full justify-between text-[11.4cqw] font-paragraph font-normal text-cs-ink leading-none tracking-tight mb-20">
          <span>PR</span>
          {/* Pill Button */}
        ...
        {/* 3 Container Layout */}
        <div className="w-full flex flex-col md:flex-row justify-between gap-12 lg:gap-8 pt-8 pb-32">
          ...
          <div className="w-full md:w-[56%] grid grid-cols-1 md:grid-cols-2 gap-y-16 lg:gap-y-20 gap-x-12 lg:gap-x-8">
            
            {/* Main Pages */}
            <div className="flex flex-col gap-4 order-1">
              <h4 className="text-xl text-cs-ink font-paragraph font-normal mb-1">Main Pages</h4>
            ...
            <div className="flex flex-col gap-4 order-2 md:order-3">
              <h4 className="text-xl text-cs-ink font-paragraph font-normal mb-1">Services</h4>
              <div className="flex flex-col gap-3.5">
                {[
            ...
            <div className="flex flex-col gap-4 order-3 md:order-2">
              <h4 className="text-xl text-cs-ink font-paragraph font-normal mb-1">Location</h4>
              <p className="text-base text-cs-ink leading-relaxed font-paragraph font-light">
            ...
            <div className="flex flex-col gap-4 order-4">
              <h4 className="text-xl text-cs-ink font-paragraph font-normal mb-1">Contact</h4>
              <div className="flex flex-col gap-3.5 text-base text-cs-ink font-paragraph font-light">
                <a href="mailto:sales@cueserve.com" className="underline decoration-solid hover:text-brand-default transition-colors">sales@cueserve.com</a>
