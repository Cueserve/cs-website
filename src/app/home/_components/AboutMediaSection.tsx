...
export function AboutMediaSection() {
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="relative z-20 bg-white pt-12 sm:pt-16 xl:pt-24 pb-48 sm:pb-64 xl:pb-80 min-h-[700px] lg:min-h-[820px]"
      >
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 object-contain filter drop-shadow-md"
                />
              </div>
      ...
      <section ref={cardsSectionRef} className="relative z-20 bg-white pt-36 lg:pt-48 pb-16 sm:pb-24 border-b border-cs-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="service-card-wrapper">
                <div
                  className="bg-blue-50 rounded-xxl p-6 flex flex-col justify-between h-[300px] hover:scale-[1.02] transition-transform duration-300 w-full"
                >
                  <div className="flex flex-col">
                    <h3 className="font-paragraph text-[48px] font-normal leading-none text-neutral-1000">
                      {service.title}
                    </h3>
                    <p className="font-paragraph text-[20px] font-normal leading-none tracking-[0.1em] uppercase text-neutral-1000 mt-[14px]">
                      {service.subtitle}
                    </p>
                  </div>
